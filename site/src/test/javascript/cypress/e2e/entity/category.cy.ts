...
describe('Category e2e test', () => {
  ...
  const categorySample = { title: 'línea end-to-end' };
  ...
  describe('Category page', () => {
    ...
    describe('with existing value', () => {
      ...
      it.skip('edit button click should load edit Category page and save', () => {
        cy.get(entityEditButtonSelector).first().click();
        cy.getEntityCreateUpdateHeading('Category');
  ...
  describe('new Category page', () => {
    ...
    it('should create an instance of Category', () => {
      cy.get(`[data-cy="title"]`).type('División a').should('have.value', 'División a');

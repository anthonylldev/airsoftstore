...
describe('SubCategory e2e test', () => {
  ...
  const subCategorySample = { title: 'virtual functionalities' };
        ...
        cy.authenticatedRequest({
          ...
          cy.intercept(
            ...
            },
            {
              statusCode: 200,
              headers: {
                link: '<http://localhost/api/sub-categories?page=0&size=20>; rel="last",<http://localhost/api/sub-categories?page=0&size=20>; rel="first"',
              },
              body: [subCategory],
            }
  ...
  describe('new SubCategory page', () => {
    ...
    it('should create an instance of SubCategory', () => {
      cy.get(`[data-cy="title"]`).type('Hogar').should('have.value', 'Hogar');

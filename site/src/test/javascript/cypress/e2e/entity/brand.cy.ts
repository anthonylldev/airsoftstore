...
describe('Brand e2e test', () => {
  ...
  const brandSample = { title: 'back-end' };
  ...
  describe('Brand page', () => {
    ...
    describe('with existing value', () => {
      ...
      it.skip('edit button click should load edit Brand page and save', () => {
        cy.get(entityEditButtonSelector).first().click();
        cy.getEntityCreateUpdateHeading('Brand');
  ...
  describe('new Brand page', () => {
    ...
    it('should create an instance of Brand', () => {
      cy.get(`[data-cy="title"]`).type('Navarra Contabilidad').should('have.value', 'Navarra Contabilidad');

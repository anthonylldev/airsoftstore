...
type CategoryFormGroupContent = {
  ...
  cover: FormControl<ICategory['cover']>;
  coverContentType: FormControl<ICategory['coverContentType']>;
};
...
export class CategoryFormService {
  createCategoryFormGroup(category: CategoryFormGroupInput = { id: null }): CategoryFormGroup {
    ...
    return new FormGroup<CategoryFormGroupContent>({
      ...
      cover: new FormControl(categoryRawValue.cover),
      coverContentType: new FormControl(categoryRawValue.coverContentType),
    });
  }
